...
import { Clock3, ArrowRight, Sparkles, Tag } from "lucide-react";
...
const SpecialOffer = () => {
  ...
  useEffect(() => {
    ...
    getCoupons("active")
      ...
      .catch((err) =>
        console.warn("Failed to fetch active coupon for SpecialOffer:", err),
      );
        ...
        >
          ...
          <div className="relative grid items-center gap-8 p-8 sm:p-10 lg:grid-cols-2 lg:gap-0 lg:p-0">
            ...
            >
              ...
              >
                Sign up today and enjoy a delicious discount on your very first
                order. Fresh meals, fast delivery, and unbeatable savings await!
              </motion.p>
