    ...
    return (
      <div className="relative inline-block text-left role-dropdown-container">
        <button
          ...
          className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold border transition-all duration-150 cursor-pointer shadow-2xs ${badgeClasses} ${isOpen ? "ring-2 ring-orange-400 ring-offset-1" : ""
            }`}
        >
          {isUpdating ? (
          ...
          <span>{role}</span>
          <ChevronDown
            className={`w-3 h-3 text-gray-400 transition-transform duration-200 ${isOpen ? "rotate-180 text-gray-600" : ""
              }`}
          />
        </button>
              ...
              {availableRoles.map((roleOpt) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-2.5 py-2 rounded-xl text-xs font-semibold transition-colors ${isCurrent
    ...
    <div className="w-full space-y-6 pb-12">
      ...
      {toast.show && (
        <div className="fixed top-6 right-6 z-50 animate-bounce duration-300">
          <div
            className={`flex items-center gap-3 px-5 py-3.5 rounded-2xl shadow-xl border text-sm font-medium ${toast.type === "success"
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
        ...
        <div
          ...
          className={`cursor-pointer rounded-2xl p-5 border transition-all duration-200 ${activeTab === "all"
        ...
        <div
          ...
          className={`cursor-pointer rounded-2xl p-5 border transition-all duration-200 ${activeTab === "restaurant"
        ...
        <div
          ...
          className={`cursor-pointer rounded-2xl p-5 border transition-all duration-200 ${activeTab === "customer"
        ...
        <div
          ...
          className={`cursor-pointer rounded-2xl p-5 border transition-all duration-200 ${activeTab === "rider"
        ...
        <div
          ...
          className={`cursor-pointer rounded-2xl p-5 border transition-all duration-200 col-span-2 sm:col-span-1 ${activeTab === "admin"
          ...
          {[
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2.5 rounded-2xl text-sm font-semibold whitespace-nowrap transition-all ${isActive
              ...
              {[
                ...
                return (
                  <div
                    ...
                    className={`cursor-pointer flex items-start gap-3 p-3.5 rounded-2xl border transition-all ${isSelected
                        ? "border-[#FF6B35] bg-orange-50/50 shadow-sm"
                        : "border-gray-100 hover:border-gray-200 bg-gray-50/50"
                      }`}
                  >
                    <div
                      className={`p-2 rounded-xl ${isSelected
