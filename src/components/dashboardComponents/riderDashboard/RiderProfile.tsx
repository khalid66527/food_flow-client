    ...
    <div className="relative w-full max-w-5xl mx-auto space-y-6 pb-12">
      ...
      {statusMessage && (
        <div className="fixed top-6 right-6 z-50 animate-bounce duration-300">
          <div
            className={`flex items-center gap-3 px-5 py-3.5 rounded-2xl shadow-xl border text-sm font-medium ${statusMessage.type === "success"
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-end gap-4 text-center sm:text-left">
                ...
                <div className="space-y-1 sm:pb-2">
                  <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                    ...
                    <span className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-bold ${(rider.status || "").toLowerCase() === "active"
                ...
                {(rider.status || "").toLowerCase() === "active" ? (
                  <>
                    <button
                      ...
                      className={`flex items-center gap-2 px-5 py-2.5 rounded-2xl text-xs font-bold border transition-all active:scale-95 shadow-sm ${rider.isAvailable
